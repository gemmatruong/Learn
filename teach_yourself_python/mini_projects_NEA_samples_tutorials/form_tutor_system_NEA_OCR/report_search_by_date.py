"""
create a SEARCH BY DATE feature. The user can enter today's date, and it will look up the database
for anyone who has a birthday. It will display their address on the screen, so your
teacher can send them a birthday card in the post
"""
...
def produce_reports_menu():
    ...
    # 4/ Sending happy birthday cards: list of all students and phone numbers
    ...
    choice = input("""
        What kind of report do you wanna get?
            ...
            d - Birthday: list of students on birthday and phone numbers
            e - Menu
            f - Quit
        Enter choice here: """)
...
def emergencies():
    print("This report is neccessary for emergent situation...")
    time.sleep(0.4)
    print("Send students emergent messages as soon as possible via their phone numbers...")
    time.sleep(0.2)
    print("")
    ...
    with open("students_details.txt", "r") as fo:
        ...
        reader = csv.reader(fo)
        for row in reader:
            print(row[0], "," , row[1], ", phone number:", row[5])
            found += 1
...
def birthday():
    print("Birthday is an important annual event of a person...")
    time.sleep(0.4)
    print("Send them cards with love via phone numbers...")
    time.sleep(0.2)
    print("")
